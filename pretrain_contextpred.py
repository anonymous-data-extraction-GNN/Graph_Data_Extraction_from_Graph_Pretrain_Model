...
def main():
    ...
    parser.add_argument('--output_model_file', type=str, default = 'saved/pretrain.pth', help='filename to output the model')
    ...
    if not args.output_model_file == "":
        state = {
            'model_substruct': model_substruct.state_dict(),
            'model_context': model_context.state_dict()
        }
        torch.save(state, args.output_model_file)
